...
export function BeneficiosForm({ id }: { id?: string }) {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="mt-6">
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Informações sobre a loja"
                      className="min-h-[120px]"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
                    Breve descrição sobre a loja, serviços oferecidos, etc.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
        ...
        <div className="flex justify-end gap-4">
          <Button
            variant="outline"
            type="button"
            onClick={() => router.push("/fornecedores-parceiros")}
          >
            Cancelar
          </Button>
